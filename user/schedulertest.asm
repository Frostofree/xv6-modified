...
int main() {
  ...
  42:	83250513          	addi	a0,a0,-1998 # 870 <malloc+0xec>
  ...
  5e:	3b9ad7b7          	lui	a5,0x3b9ad
  62:	a0078793          	addi	a5,a5,-1536 # 3b9aca00 <base+0x3b9ab9f0>
  ...
  94:	35c080e7          	jalr	860(ra) # 3ec <waitx>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44c:	4a850513          	addi	a0,a0,1192 # 8f0 <digits>
 450:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 550:	34c70713          	addi	a4,a4,844 # 898 <malloc+0x114>
 ...
 5da:	31ab8b93          	addi	s7,s7,794 # 8f0 <digits>
 ...
 62e:	26690913          	addi	s2,s2,614 # 890 <malloc+0x10c>
        while(*s != 0){
